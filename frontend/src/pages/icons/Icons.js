                    ...
                    <div className="page-header">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Material design icons
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="row icons-list">
                                        ...
                                        <div className="col-sm-6 col-md-4 col-lg-3">
                                            <i className="mdi mdi-account-settings-variant"></i> mdi
                                        ...
                                        <div className="col-sm-6 col-md-4 col-lg-3">
                                            <i className="mdi mdi-arrow-compress-all"></i> mdi
                                        ...
                                        <div className="col-sm-6 col-md-4 col-lg-3">
                                            <i className="mdi mdi-flag-outline-variant"></i> mdi
                                        ...
                                        <div className="col-sm-6 col-md-4 col-lg-3">
                                            <i className="mdi mdi-format-list-numbers"></i> mdi
                                        ...
                                        <div className="col-sm-6 col-md-4 col-lg-3">
                                            <i className="mdi mdi-fridge-filled-bottom"></i> mdi
                                        ...
                                        <div className="col-sm-6 col-md-4 col-lg-3">
                                            <i className="mdi mdi-tooltip-outline-plus"></i> mdi
