...
jQuery(document).ready(function () {
  jQuery(".ui-elements-link").children('.ui-elements').append("<span class=\"Expander\">+</span>");

  jQuery(".ui-elements-link").click(function () {
    buttonText = jQuery(this).children('.ui-elements').html() == "-" ? "+" : "-";
    jQuery(this).children('.ui-elements').html(buttonText);
